...
const About = () => {
  return (
    <div className="container about-main font-primary" id="about">
      <div className="about-content">
        ...
        <div className="about-info">
          Spectrum is 72 hour long, virtual designathon for designers from all
          over the globe. It's a perfect blend of Ideating, Problem Solving and
          Designing industry level problem statements.
        </div>
      </div>
